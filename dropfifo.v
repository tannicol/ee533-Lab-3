...
// /___/   /\     Timestamp : 01/31/2026 19:56:24
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w C:/Xilinx/10.1/ISE/lab3_ee533/dropfifo.sch dropfifo.vf
...
module dropfifo(clk, 
   ...
   dual9Bmem XLXI_7 (.addra(waddr[7:0]), 
                     .addrb(raddr[7:0]), 
                     .clka(clk), 
                     .clkb(clk), 
                     .dina(in_fifo0[71:0]), 
                     .wea(XLXN_40[0]), 
                     .doutb(out_fifo[71:0]));
   comp8_MUSER_dropfifo XLXI_9 (.A(waddr[7:0]), 
                                .B(raddr[7:0]), 
                                .EQ(XLXN_16));
   comp8_MUSER_dropfifo XLXI_10 (.A(raddr[7:0]), 
                                 .B(XLXN_20[7:0]), 
                                 .EQ(XLXN_18));
   ...
   OR2 XLXI_14 (.I0(XLXN_3), 
                .I1(XLXN_2), 
                .O(XLXN_4));
   AND2B1 XLXI_15 (.I0(XLXN_30), 
                   .I1(XLXN_4), 
                   .O(XLXN_44));
   AND3B2 XLXI_16 (.I0(XLXN_18), 
                   .I1(XLXN_16), 
                   .I2(fiforead), 
                   .O(XLXN_32));
   VCC XLXI_17 (.P(XLXN_39));
endmodule
